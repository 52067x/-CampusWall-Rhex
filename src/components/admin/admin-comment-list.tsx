...
import { AdminCampusAiModerationButton } from "@/components/admin/admin-campus-ai-moderation-button"
    ...
    <div className="flex justify-end">
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-36">
          ...
          <DropdownMenuItem onClick={() => setActiveAction("ai-review")}>
            AI 审核
          </DropdownMenuItem>
      ...
      <AdminCampusAiModerationButton
        targetType="comment"
        targetId={comment.id}
        title={comment.postTitle}
        hideTrigger
        open={activeAction === "ai-review"}
        onOpenChange={(open) => setActiveAction(open ? "ai-review" : null)}
      />
