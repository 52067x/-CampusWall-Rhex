...
const ADMIN_MODULE_SEARCH_ITEMS: AdminModuleSearchItem[] = [
  ...
  { href: "/admin/apps/campus-ai-moderation", label: "校园墙 AI 审核", category: "应用设置", description: "检测帖子、评论和临时文本是否符合国家法律、文明规范与微信小程序规范。", keywords: ["ai审核", "AI审核", "校园墙", "内容风控", "微信规范", "小程序审核", "自动审核", "违规检测", "人工复核"] },
  ...
  { href: getAdminSettingsHref("registration", "sms"), label: "短信配置", category: "站点设置子页", description: "配置内置阿里云短信发送器，以及发送短信前的站内验证码校验。", keywords: ["短信", "手机短信", "阿里云短信", "aliyun sms", "accesskey", "短信签名", "模板code", "手机验证码", "短信验证码", "短信防刷"] },
