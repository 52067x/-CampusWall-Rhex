export const HOST_APPS = [
  ...
  {
    id: "campus-ai-moderation",
    slug: "campus-ai-moderation",
    name: "校园墙 AI 审核",
    description: "面向校园墙帖子、评论和临时文本的合规检测，支持按微信小程序规范自动转人工复核或下线处理。",
    href: "/admin/apps/campus-ai-moderation",
    adminHref: "/admin/apps/campus-ai-moderation",
    category: "风控",
  },
  {
    id: "gobang",
